...
owner: doubao
updated_at: 2026-09-16 10:05
round: 14
batch_size: shelf（整货柜）
batch_index: W1-SHELF4（续 NO 71–367）
task: 任务3 · W1-SHELF4 NO 31–367 + W1-SHELF5 NO 1–333（货柜级执行模式）
awaiting: 货柜级进度：块6（NO71-90）已写回；块7（NO91-110）已写回；块8（NO111-130：命中3+死库存15含请特批NO128+待定2）已写回；块9（NO131-150：命中5=NO133/136/140/143/150 + 死库存13 + 请特批2=NO132/135）已写回；近3年已命中追加 seq 193-211（块7 11 行 + 块8 3 行 + 块9 5 行）。继续货柜级执行 NO151-367；整柜完成后 `ready_for_cursor_check` / owner=cursor。勿先做 SHELF5。识图/条码/淡蓝硬规则不变。
