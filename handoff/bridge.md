更新：2026-09-16 14:36（SHELF5 块5 NO81-100 已写回：命中2+死库存13+待校5）
...
owner: doubao
updated_at: 2026-09-16 14:36
round: 24
batch_size: shelf（整货柜）
batch_index: W1-SHELF5（NO 1–333）
task: 任务3 · W1-SHELF4 NO 31–367 + W1-SHELF5 NO 1–333（货柜级执行模式）
awaiting: SHELF5 块5（NO81-100）已写回（命中2+死库存13+待校5），继续块6（NO101-120）。整柜完成再 ready_for_cursor_check。禁止回头改已通过的 SHELF4 判定；禁止把已撤 30 行非 PEN 改回命中。
