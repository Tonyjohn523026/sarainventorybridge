...
owner: doubao
updated_at: 2026-09-16 21:30
round: 25
batch_size: shelf（整货柜）
batch_index: W1-SHELF5（NO 1–333）
task: 任务3 · W1-SHELF4 NO 31–367 + W1-SHELF5 NO 1–333（货柜级执行模式）
awaiting: Cursor 整柜初检 fail（W1-SHELF5 NO1–333）。按下方 issues 只改本柜点名命中行 + 近3年需撤行 + 块13–17 漏做行。禁止回头改已通过的 SHELF4 判定；禁止把 SHELF4 已撤 30 行非 PEN 改回命中。改完再 ready_for_cursor_check / owner=cursor。
