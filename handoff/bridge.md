# Cursor ↔ 豆包 协同桥接（状态机）
更新：2026-09-15 22:20（Cursor 抽查批3 → needs_doubao_fix）
...
status: batch_ready
owner: cursor
updated_at: 2026-09-15 23:05
round: 6
batch_size: 20
batch_index: 3
task: W1-SHELF4 NO 11–31（任务2）+ 任务3（SHELF4 剩余 + SHELF5 全量，用户已指示）
awaiting: Cursor 复检批3 修正（NO 11–30）；任务3 计划待批（见①区）
