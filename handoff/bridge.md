更新：2026-09-16 14:47（SHELF5 块6 NO101-120 已写回：命中6+死库存12+待校2）
...
owner: doubao
updated_at: 2026-09-16 14:47
round: 24
batch_size: shelf（整货柜）
batch_index: W1-SHELF5（NO 1–333）
task: 任务3 · W1-SHELF4 NO 31–367 + W1-SHELF5 NO 1–333（货柜级执行模式）
awaiting: SHELF5 块6（NO101-120）已写回（命中6+死库存12+待校2），继续块7（NO121-140）。整柜完成再 ready_for_cursor_check。禁止回头改已通过的 SHELF4 判定；禁止把已撤 30 行非 PEN 改回命中。
