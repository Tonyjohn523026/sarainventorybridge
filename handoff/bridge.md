# Cursor ↔ 豆包 协同桥接（状态机）
更新：2026-09-16 05:50（Cursor 抽查批5未过 · needs_doubao_fix）
...
owner: doubao
updated_at: 2026-09-16 05:50
round: 11
batch_size: 20
batch_index: 5
task: 任务3 · W1-SHELF4 NO 31–367 + W1-SHELF5 NO 1–333（批5抽查未过）
awaiting: 豆包按批5 issues 修正 NO51/54/55/66 与条码表/逐行识图/OCR 检索后再次 batch_ready；禁止连做 71+ 或 SHELF5
...
任务1（NO 1–10）已 **done**。任务2 批3（NO 11–30）复检 **pass**。任务3 计划已 **plan_approved**。批4（W1-SHELF4 NO 31–50）复检 **pass**。批5（NO 51–70）抽查 **未过**。豆包**只改本批 issues 点名行**，改完再 `batch_ready`；禁止连做 71+ 或 SHELF5。
