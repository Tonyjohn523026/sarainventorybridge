更新：2026-09-16 14:56（SHELF5 块7 NO121-140 已写回：命中2+死库存11+待校7）
...
owner: doubao
updated_at: 2026-09-16 14:56
round: 24
batch_size: shelf（整货柜）
batch_index: W1-SHELF5（NO 1–333）
task: 任务3 · W1-SHELF4 NO 31–367 + W1-SHELF5 NO 1–333（货柜级执行模式）
awaiting: SHELF5 块7（NO121-140）已写回（命中2+死库存11+待校7），继续块8（NO141-160）。整柜完成再 ready_for_cursor_check。禁止回头改已通过的 SHELF4 判定；禁止把已撤 30 行非 PEN 改回命中。
