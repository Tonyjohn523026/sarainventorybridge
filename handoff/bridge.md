...
owner: doubao
updated_at: 2026-09-16 09:50
round: 14
batch_size: shelf（整货柜）
batch_index: W1-SHELF4（续 NO 71–367）
task: 任务3 · W1-SHELF4 NO 31–367 + W1-SHELF5 NO 1–333（货柜级执行模式）
awaiting: 货柜级进度：块6（NO71-90，20 行全死库存）已写回；块7（NO91-110，20 行：命中4=NO91/97/101/108 + 死库存13 + 请特批3=NO95/103/107 + 待定1=NO109）已写回；块8（NO111-130，20 行：命中3=NO112/121/127 + 死库存15含请特批NO128 + 待定2=NO129/130）已写回；近3年已命中追加 seq 193-206（块7 11 行 + 块8 3 行）。继续货柜级执行 NO131-367；整柜完成后 `ready_for_cursor_check` / owner=cursor。勿先做 SHELF5。识图/条码/淡蓝硬规则不变。
