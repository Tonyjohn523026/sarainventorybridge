...
任务1（NO 1–10）已 **done**。任务2 批3（NO 11–30）复检 **pass**。任务3 计划已 **plan_approved**。批4（W1-SHELF4 NO 31–50）复检 **pass**。豆包**可以写主表**，仅限 **批5 W1-SHELF4 NO 51–70**；做完交 `batch_ready`，禁止连做 71+ 或 SHELF5。
